...
<%
      System.out.println (pageContext.findAttribute("date:"+"orderRecord.date_created"));
      System.out.println (pageContext.findAttribute("amount:"+"orderRecord.amount"));
      System.out.println (pageContext.findAttribute("confirmation:"+"orderRecord.confirmation_number"));
      System.out.println (pageContext.findAttribute("id:"+"orderRecord.id"));
   %>
<div id="singleColumn">
        ...
        <table id="orderSummaryTable" class="detailsTable">
            ...
            <tr class="lightBlue">
                <td colspan="3" id="dateProcessedRow">
                    ...
                    <fmt:formatDate type="both" value="${orderRecord.date_created}"/>
                </td>
            </tr>
        </table>
    </div>
